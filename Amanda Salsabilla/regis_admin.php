...
<html lang="en">
  ...
  <div class="row justify-content-around pt-5">
    ...
    <main role="main" class="flex-shrink-0">
 	<div class="container">
 		<h2 class="mt-4">Registrasi Admin</h1>
 		<hr/>
        ...
        <br>
 		<div class="form-group pb-4">
 			<div class="col">
 				<button type="submit" class="btn btn-primary" name="registrasi_admin">Registrasi</button>
 			</div>
 		</div>
		<p style="font-family:arial;">sudah punya akun?<a href="login_admin.php" style="text-decoration:none;">Login sekarang</a></p>
 	</form>
 </div>
</main>
