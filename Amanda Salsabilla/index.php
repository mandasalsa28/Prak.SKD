...
<head>
  ...
  <title>PT. SAPTAKENCANA K.J</title>
  <style>
    body{
...
<h2>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col">
        <h4>Selamat Datang di PT. Saptakencana Kharisma Jaya</h4>
        <center><img src="tamrin2.jpg" width="500" height="280" class="d-inline-block align-text-middle" alt="..."></center>
        <br>
        <p style="text-align:justify">PT.SAPTAKENCANA KHARISMA JAYA adalah perusahaan yang mapan sejak lebih dari 12 tahun, 
        menyediakan layanan rekayasa yang komprehensif - desain, pengiriman dan instalasi - sistem kelistrikan 
        dan mekanik untuk pemilik bangunan dan industri. Perusahaan berkomitmen untuk menyediakan sistem, material, 
        dan layanan berkualitas tinggi untuk memenuhi kebutuhan pelanggan kami yang berharga. Semua anggota pendiri 
        perusahaan memiliki pengalaman luas dalam implementasi dan pemasangan berbagai proyek mulai dari perumahan, 
        bangunan industri hingga hotel, menara perkantoran, dan pusat perbelanjaan.
        </p>
		    <p style="text-align:justify">Terima kasih telah mengunjungi website kami. Jika Anda membutuhkan informasi tambahan, 
        silakan gunakan informasi kontak yang tersedia dan kami akan dengan senang hati membantu Anda.
        </p>
      </div>
    </div>
  </div>
